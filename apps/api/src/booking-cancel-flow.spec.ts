...
// the same auth_rate_limits table within one test run. Draw from
// crypto.randomUUID() so cross-file collisions within a single 60s
// rate-limit window are statistically negligible across the whole suite.
