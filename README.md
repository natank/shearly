...
MVP documentation is in `/docs`. **M0–M3** are on `main`. Next: `docs/mvp/04-implementation-plan/m4-transaction.md`.
...
docker compose up -d
# First M3 checkout: `docker compose down -v` if the volume was vanilla Postgres 16.
